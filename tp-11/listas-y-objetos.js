...
function ordenarPorApellido(listaDePersonas) {
    return [...listaDePersonas].sort((personaA, personaB) =>
        personaA.apellido.localeCompare(personaB.apellido)
    );
}
...
function promedioEdades(listaDePersonas) {
    ...
    const sumaEdades = listaDePersonas.reduce((acumulado, persona) => acumulado + persona.edad, 0);
